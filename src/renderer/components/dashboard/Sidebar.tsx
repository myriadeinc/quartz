          ...
          >
            ...
            <Grid item sm={12} className={classes.grid}>
              <Card className={classes.balanceCard}>
                <Typography display="inline" className={classes.balanceTitleMc}>
                  Mining Credits:{" "}
                </Typography>
                <Typography display="inline" className={classes.balanceMc}>
                  {miner.mcBalance}
                </Typography>
                ...
                {dashboardRoutes.map(
                  (route) =>
                    route.visible && (
                      ...
                      >
                        <Typography className={classes.navigationMenu}>
                          {route.name}
                        </Typography>
                      </NavLink>
                    )
